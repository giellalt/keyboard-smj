.. -*- mode: rst -*-
==========================================
 Keyboards for the Lule Sami language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Lule Sami language. The data and implementations
...
* http://giellatekno.uit.no/smjdoc/index.html
* https://giellalt.uit.no/tools/docu-smj-manual.html
...
The Lule Sami keyboard sources can be acquired using the `Giella SVN
